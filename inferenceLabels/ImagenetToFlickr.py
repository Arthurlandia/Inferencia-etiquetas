...
# beatuifulsoup
conf = SparkConf().setAppName("ImagenetToFlickr").setMaster("spark://192.168.1.9:7077")
...
if __name__ == '__main__':
    ...
    tags_join = tags_mirflickrRDD \
        .join(tags_imagenetRDD) \
    ...
    comunes = spark.sparkContext.textFile(path_hdfs+"mirflickr/commons").collect()
    ...
    prediccionesRDD \
        ...
        .json(path_hdfs + "mirflickr/predictions")
